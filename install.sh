#!/bin/sh
# install.sh — install the appetite binary from GitHub Releases.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/luuuc/appetite/main/install.sh | sh
#
# Installs to /usr/local/bin/appetite (or ~/.local/bin/appetite if
...
echo "Fetching latest appetite release..."
...
ARCHIVE="appetite_${VERSION}_${OS}_${ARCH}.tar.gz"
CHECKSUMS="appetite_${VERSION}_checksums.txt"
...
mv "${WORK_DIR}/appetite" "${INSTALL_DIR}/appetite"
chmod +x "${INSTALL_DIR}/appetite"

echo ""
echo "appetite ${VERSION} installed to ${INSTALL_DIR}/appetite"
"${INSTALL_DIR}/appetite" version
